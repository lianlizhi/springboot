...
public class WebUtil {
	 ...
	 */
	/*
	 * public static void write(String jsonString){ try { //响应对象 HttpServletResponse
	 * response = ServletActionContext.getResponse(); //设置编码
	 * response.setContentType("text/html;charset=utf-8"); //输出给页面
