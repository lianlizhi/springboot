...
Date: 2019-02-21 16:57:05
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for t_vio_stat_work_by_inputtime
-- ----------------------------
CREATE TABLE IF NOT EXISTS `t_vio_stat_work_by_inputtime` (
  ...
  PRIMARY KEY (`F_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='违法录入人员考核表（按录入时间）';
