...
-- ----------------------------
-- Table structure for t_vio_stat_work_by_viotime
-- ----------------------------
CREATE TABLE IF NOT EXISTS `t_vio_stat_work_by_viotime` (
  ...
  PRIMARY KEY (`F_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='违法录入人员考核表（按违法时间）';
