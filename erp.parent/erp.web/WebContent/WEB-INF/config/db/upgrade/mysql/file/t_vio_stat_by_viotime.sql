...
Date: 2019-02-25 11:13:14
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for t_vio_stat_by_viotime
-- ----------------------------
CREATE TABLE IF NOT EXISTS `t_vio_stat_by_viotime` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='违法数据统计表（按违法时间）';
