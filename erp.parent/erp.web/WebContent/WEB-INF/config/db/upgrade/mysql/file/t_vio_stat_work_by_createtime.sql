...
Date: 2019-02-21 16:56:58
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for t_vio_stat_work_by_createtime
-- ----------------------------
CREATE TABLE IF NOT EXISTS `t_vio_stat_work_by_createtime` (
  ...
  PRIMARY KEY (`F_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='违法录入人员考核表（按入库时间）';
