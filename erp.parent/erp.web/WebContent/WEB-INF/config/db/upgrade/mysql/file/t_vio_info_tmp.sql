...
Date: 2018-09-11 15:46:37
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for t_vio_info_tmp
-- ----------------------------

CREATE TABLE `t_vio_info_tmp` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='违法信息临时表';
