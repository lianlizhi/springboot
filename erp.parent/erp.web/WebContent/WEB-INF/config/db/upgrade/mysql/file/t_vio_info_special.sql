...
Date: 2018-09-11 15:57:18
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for t_vio_info_special
-- ----------------------------

CREATE TABLE `t_vio_info_special` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='特牌车违法信息表';
