...
Date: 2019-02-25 11:13:08
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for t_vio_stat_by_inputtime
-- ----------------------------
CREATE TABLE IF NOT EXISTS `t_vio_stat_by_inputtime` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='违法数据统计表（按录入时间）';
